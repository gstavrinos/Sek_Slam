...
public class TouchAndTilt extends FragmentActivity implements SensorEventListener,OnClickListener,
ActionBar.OnNavigationListener, OnTouchListener{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		brake.setOnTouchListener(TouchAndTilt.this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.touch_and_tilt, menu);
		return true;
	}
